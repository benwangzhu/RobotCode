...
.program pg.cnv_pt_posn_(.Vx, .Vy, .Ox, .Oy, .NumAs, .E7CoordMode, .&PFrame, .&InPosn, .MaxJ7, .MinJ7, .MinDist, .RlE7Pos, .&OutPosn) 
    ...
    if .NumAs == 7 then 
        ...
        .OutPosAry[6] = .InPosAry[6]

        case .E7CoordMode of

        value 2:

            .OutPosAry[6] = .OutPosAry[6] + .OutPosAry[1]
            .OutPosAry[1] = 0.0

            if (abs(.OutPosAry[0]) < abs(.MinDist)) and (.OutPosAry[6] < .RlE7Pos) then  

                .OutPosAry[1] = sqrt(.MinDist * .MinDist - .OutPosAry[0] * .OutPosAry[0]) * (-1)
                .OutPosAry[6] = .OutPosAry[6] + sqrt(.MinDist * .MinDist - .OutPosAry[0] * .OutPosAry[0])
            else
                if (abs(.OutPosAry[0]) < abs(.MinDist)) and (.OutPosAry[6] >= .RlE7Pos) then
            ...
            if .OutPosAry[6] <= .MinJp7 then
                .OutPosAry[1] = .OutPosAry[1] + .OutPosAry[6] - .MinJp7
                .OutPosAry[6] = .MinJp7
            end
            if .OutPosAry[6] >= .MaxJp7 then
                .OutPosAry[1] = .OutPosAry[1] + .OutPosAry[6] - .MaxJp7
                .OutPosAry[6] = .MaxJp7
            end

        value 1:

            .OutPosAry[6] = .OutPosAry[6] + .OutPosAry[0]
            .OutPosAry[0] = 0.0

            if (abs(.OutPosAry[1]) < abs(.MinDist)) and (.OutPosAry[6] < .RlE7Pos) then  

                .OutPosAry[0] = sqrt(.MinDist * .MinDist - .OutPosAry[1] * .OutPosAry[1]) * (-1)
                .OutPosAry[6] = .OutPosAry[6] + sqrt(.MinDist * .MinDist - .OutPosAry[1] * .OutPosAry[1])
            else
                if (abs(.OutPosAry[1]) < abs(.MinDist)) and (.OutPosAry[6] >= .RlE7Pos) then
            ...
            if .OutPosAry[6] <= .MinJp7 then
                .OutPosAry[0] = .OutPosAry[0] + .OutPosAry[6] - .MinJp7
                .OutPosAry[6] = .MinJp7
            end
            if .OutPosAry[6] >= .MaxJp7 then
                .OutPosAry[0] = .OutPosAry[0] + .OutPosAry[6] - .MaxJp7
                .OutPosAry[6] = .MaxJp7
            end
        any :
    ...
    if .NumAs == 7 then
        ...
        point/7 .&OutPosn = trans(0, 0, 0, 0, 0, 0, .OutPosAry[6])
    end
